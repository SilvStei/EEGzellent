...
if not all_files_loaded:
    ...
    num_features_per_channel = 5  # Anzahl der Features pro Kanal
    ...
    feature_names = ['theta_power', 'alpha_power', 'adaptive_fourier_decomposition', 'zero_crossing_rate', 'line_length']
