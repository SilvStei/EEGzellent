...
if __name__ == '__main__':
    ...
    performance_metric_SS23 = metrics["performance_metric_SS23"]
    F1 = metrics["F1"]
    detection_error_onset = metrics["detection_error_onset"]
    sensitivity = metrics["sensitivity"]
    PPV = metrics["PPV"]
    accuracy = metrics["accuracy"]
    detection_error_offset = metrics["detection_error_offset"]
    TP = metrics["TP"]
    FN = metrics["FN"]
    FP = metrics["FP"]
    TN = metrics["TN"]
    
    print("WKI Metrik:", performance_metric)
    print("Performance Metric SS23:", performance_metric_SS23)
    print("F1-Score:", F1)
    print("Sensitivität:", sensitivity)
    print("PPV:", PPV)
    print("Accuracy:", accuracy)
    print("Latenz (Onset Error):", detection_error_onset)
    print("Latenz (Offset Error):", detection_error_offset)
